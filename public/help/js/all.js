...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["Página principal","1. Iniciar Sesión","2. Registrar usuario","3. Almacén","4. Compras","5. Ventas","6. Reportes","Categorias","Productos","Proveedores","Ingresos","Clientes","Ventas"],
    DREX_NODE_LINKS: ["index.htm","iniciar_sesion.htm","registrar_usuario.htm","3__almacen.htm","4__compras.htm","5__ventas.htm","6__reportes.htm","categorias.htm","productos.htm","proveedores.htm","ingresos.htm","clientes.htm","ventas.htm"],
    DREX_NODE_CHILD_START: [1,7,7,7,9,11,13,13,13,13,13,13,13],
    DREX_NODE_CHILD_END: [7,7,7,9,11,13,13,13,13,13,13,13,13],
    DREX_MENU_TYPE: 1,
...
DR_EXPLAIN.data_search = {
    ...
    DREXPLAIN_ERROR_LOCAL_SEARCH : "Google Chrome y Opera 12.02 incluidas las versiones anteriores no son compatibles con la b&#x00FA;squeda entre archivos HTML locales. Cargue los archivos al servidor web o utilice otro navegador."
